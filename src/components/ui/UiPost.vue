<template>
  <div class="post w-100 mt-3" v-if="post != null">
    <div class="d-flex py-3 px-2 w-100 align-items-start nowrap post-header">
      <b-avatar
      ...
      <div class="flex-grow-1 px-2 overflow-hidden d-block align-items-center" style="margin-top: 3px;">
      ...
      <div class="d-flex align-items-center text-white" style="margin-top: 4px;">
        ...
        <b-dropdown no-caret right variant="link" class="ml-1">
          <template slot="button-content"><i class="bi-three-dots-vertical" style="color: #262626; font-size: 21px;"/></template>
    ...
    <div class="w-100 overflow-hidden nl2br wrap post-message">
      {{ post.message }}
    </div>
    <div class="d-flex align-items-center post-likes">
      <div class="like-count">
        <img src="../../assets/icons/heart-filled.svg" alt="icon" class="post-icon">
        {{ post.likesCount }}
    ...
    <b-card-footer class="post-footer">
      <div class="d-flex justify-content-between">
        <b-link
            href="#"
            class="p-2 nounderline"
            @click.prevent="like"
            :disabled="!hasAccess"
        >
          <img v-if="post.isLiked === false" src="../../assets/icons/heart-filled.svg" alt="icon" class="post-icon">
          <img v-else src="../../assets/icons/heart.svg" alt="icon" class="post-icon">
          {{ $t("general.like") }}
        </b-link>
        <b-link
            class="p-2 nounderline"
            ...
            v-if="!isOwner"
        >
          <img src="../../assets/icons/tip.svg" alt="icon" class="post-icon">
          {{ $t("general.send-tip") }}
        </b-link>
        <b-link
            class="p-2 nounderline"
            @click.prevent="copyLink">
          <img src="../../assets/icons/share.svg" alt="icon" class="post-icon">
          {{ $t("general.share") }}
        </b-link>
      </div>
    </b-card-footer>
